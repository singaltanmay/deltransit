...
public class GeoLocationHelper {
     ...
     */
    public static GeoLocationHelper fromDegrees(double latitude, double longitude) {
        GeoLocationHelper result = new GeoLocationHelper();
     ...
     */
    public static GeoLocationHelper fromRadians(double latitude, double longitude) {
        GeoLocationHelper result = new GeoLocationHelper();
     ...
     * argument.
     */
    public double distanceTo(GeoLocationHelper location, Double radius) {
     ...
     * </ul>
     */
    public GeoLocationHelper[] boundingCoordinates(double distance, Double radius) {
        ...
        return new GeoLocationHelper[]{fromRadians(minLat, minLon),
